...
This MCP server implements **~165 tools** covering ~90% of the [python-garminconnect](https://github.com/cyberjunky/python-garminconnect) library (v0.3.5):
...
- ✅ Workouts (15 tools) - includes Garmin Coach plan workouts and adaptive-plan detail (race goal, confidence, training week)
- ✅ Devices (6 tools)
...
This server registers ~165 tools by default, which can be a lot of context for
